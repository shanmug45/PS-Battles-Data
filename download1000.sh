...
#check for tsv files
[ ! -f originals1000.tsv ] && { echo "originals1000.tsv not found"; exit 127; }
[ ! -f photoshops1000.tsv ] && { echo "photoshops1000.tsv not found"; exit 127; }
...
#Progress Reporting
originalsWC=$(wc -l < originals1000.tsv)
...
#Progress Reporting
photoshopWC=$(wc -l < photoshops1000.tsv)
