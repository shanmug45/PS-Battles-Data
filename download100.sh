...
#check for tsv files
[ ! -f originals100.tsv ] && { echo "originals100.tsv not found"; exit 127; }
[ ! -f photoshops100.tsv ] && { echo "photoshops100.tsv not found"; exit 127; }
...
#Progress Reporting
originalsWC=$(wc -l < originals100.tsv)
...
#Progress Reporting
photoshopWC=$(wc -l < photoshops100.tsv)
